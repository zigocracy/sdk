...
/**
 * A code-generation module that transforms a [com.zigocracy.sdk.processor.ResolvedGrammar] into a build artifact.
 *
 ...
 * against hand-constructed [com.zigocracy.sdk.processor.ResolvedGrammar] instances without a running compiler.
 *
 * ## Adding a new emitter
 *
 * 1. Implement this interface.
 * 2. Register the emitter in [com.zigocracy.sdk.processor.GrammarResolver.emitters].
 ...
 *
 * @see com.zigocracy.sdk.processor.GrammarResolver
 * @see com.zigocracy.sdk.processor.ResolvedGrammar
 */
public interface GrammarEmitter {
	 ...
	 *
	 * Called by the [com.zigocracy.sdk.processor.GrammarResolver] after the model has been validated.
