...
/**
 * Resolves the physical length of the current vertical whitespace sequence.
 *
 * This function handles both single-character and multi-character line break
 * sequences (such as LF and CRLF), returning the exact span width required
 * to consume the entire newline marker.
 *
 * @param reader The text stream viewer.
 * @param offset The starting position relative to the current cursor.
 * @return The total physical width consumed by the newline sequence.
 */
