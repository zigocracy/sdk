...
enum class RecoveryContext {
	...
	/**
	 * Evaluates whether a continuous sequence of horizontal whitespace characters
	 * should be consumed as valid interior literal content or preserved for the WhitespaceScanner.
	 *
	 * This predicate enforces the critical whitespace isolation invariant during error recovery.
	 */
